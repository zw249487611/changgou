...
public class SpecController {
     ...
     * @param categoryId
     */
    @ApiOperation(value = "查询规格集合", notes = "查根据template_id查询规格集合", tags = {"SpecController"})
    @GetMapping(value = "categpry/{id}")
    public Result<List<Spec>> findByCategoryId(@PathVariable("id") Integer categoryId) {
        ...
        return new Result<List<Spec>>(true, StatusCode.OK,"查询规格集合成功",specList) ;
    }
}
